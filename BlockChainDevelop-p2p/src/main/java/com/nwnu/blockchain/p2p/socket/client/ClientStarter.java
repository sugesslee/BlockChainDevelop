...
import com.nwnu.blockchain.p2p.core.event.NodesConnectedEvent;
...
import com.nwnu.blockchain.p2p.socket.vote.NextBlockPacketBuilder;
...
public class ClientStarter {
	...
	public int halfGroupSize() {
		SetWithLock<ChannelContext> setWithLock = clientGroupContext.groups
				.clients(clientGroupContext, Const.GROUP_NAME);
